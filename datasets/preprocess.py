...
from utils.protein import constants, parsers
...
def _preprocess_structures(path, relax_or_pred=False):
    ...
    preprocess_sabdab_structure(tasks[0], sasa=True)
...
if __name__ == '__main__':
    ...
    # data path root
    processed_dir = '/home/gli/project/Data/data_surface/processed'
    chothia_dir = '/home/gli/project/Data/data_surface/all_structures/chothia'
    ...
    if not os.path.exists(_entry_cache_path) or reset:
        ...
        summary_path = '/home/gli/project/Data/data_surface/sabdab_summary_all.tsv'
